...
1. **Landing Page**
   <br/>
   <img width="600" height="500" alt="Landing Page" src="https://github.com/Yi-Terry/languageApp/blob/main/assets/images/beyondlanguage3.png">
   <br/>
  
2. **Levels Page**
   <br/>
   <img width="600" height="500" alt="Dashboard" src="https://github.com/Yi-Terry/languageApp/blob/main/assets/images/beyondlanguage1.png">
   <br/>
   User can choose between 4 different levels
   
3. **Admin Page**
   <br/>
   <img width="600" height="500" alt="Dashboard" src="https://github.com/Yi-Terry/languageApp/blob/main/assets/images/beyondlanguage2.png">
   <br/>
